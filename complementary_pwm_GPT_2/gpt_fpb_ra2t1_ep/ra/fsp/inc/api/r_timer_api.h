...
typedef enum e_timer_compare_match
{
    ...
    TIMER_COMPARE_MATCH_E = 3U,        ///< Compare match E value
    TIMER_COMPARE_MATCH_D = 4U,        ///< Compare match D value
...
typedef struct st_timer_api
{
     ...
     *
     * @param[in]   p_ctrl                  Control block set in @ref timer_api_t::open call for this timer.
     * @param[in]   compare_match_value     Match value to trigger a compare match event.
     * @param[in]   compare_match_channel   Which channel to update.
     */
