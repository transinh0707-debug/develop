...
const gpt_extended_cfg_t g_timer_Comp_pwm_counting_capture_extend =
        ...
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          ...
          .count_up_source = (gpt_source_t) (GPT_SOURCE_NONE), .count_down_source = (gpt_source_t) (GPT_SOURCE_NONE), .capture_a_source =
                  (gpt_source_t) (GPT_SOURCE_GTIOCA_RISING_WHILE_GTIOCB_LOW | GPT_SOURCE_NONE),
          .capture_b_source = (gpt_source_t) (GPT_SOURCE_GTIOCA_FALLING_WHILE_GTIOCB_LOW | GPT_SOURCE_NONE), .capture_a_ipl =
                  (2),
          .capture_b_ipl = (2),
...
{ .trough_ipl = (BSP_IRQ_DISABLED),
  ...
  .gtiocb_disable_setting = GPT_GTIOC_DISABLE_PROHIBITED, };
#endif
const gpt_extended_cfg_t g_timer_comp_pwm_slave2_extend =
        { .gtioca =
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT2_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 1
          .p_pwm_cfg = &g_timer_comp_pwm_slave2_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_comp_pwm_slave2_cfg =
{ .mode = TIMER_MODE_COMPLEMENTARY_PWM_MODE1,
/* Actual period: 0.00064 seconds. Actual duty: 60%. */.period_counts = (uint32_t) 0xa000,
  .duty_cycle_counts = 0x6000, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_comp_pwm_slave2_extend,
  .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_comp_pwm_slave2 =
{ .p_ctrl = &g_timer_comp_pwm_slave2_ctrl, .p_cfg = &g_timer_comp_pwm_slave2_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_comp_pwm_slave1_ctrl;
#if 1
const gpt_extended_pwm_cfg_t g_timer_comp_pwm_slave1_pwm_extend =
{ .trough_ipl = (BSP_IRQ_DISABLED),
  ...
  .gtiocb_disable_setting = GPT_GTIOC_DISABLE_PROHIBITED, };
#endif
const gpt_extended_cfg_t g_timer_comp_pwm_slave1_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT1_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 1
          .p_pwm_cfg = &g_timer_comp_pwm_slave1_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_comp_pwm_slave1_cfg =
{ .mode = TIMER_MODE_COMPLEMENTARY_PWM_MODE1,
/* Actual period: 0.00064 seconds. Actual duty: 60%. */.period_counts = (uint32_t) 0xa000,
  .duty_cycle_counts = 0x6000, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_comp_pwm_slave1_extend,
  .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_comp_pwm_slave1 =
{ .p_ctrl = &g_timer_comp_pwm_slave1_ctrl, .p_cfg = &g_timer_comp_pwm_slave1_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_comp_pwm_master_ctrl;
#if 1
const gpt_extended_pwm_cfg_t g_timer_comp_pwm_master_pwm_extend =
{ .trough_ipl = (BSP_IRQ_DISABLED),
  ...
  .gtiocb_disable_setting = GPT_GTIOC_DISABLE_PROHIBITED, };
#endif
const gpt_extended_cfg_t g_timer_comp_pwm_master_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT0_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 1
          .p_pwm_cfg = &g_timer_comp_pwm_master_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
{ .mode = TIMER_MODE_COMPLEMENTARY_PWM_MODE1,
/* Actual period: 0.00064 seconds. Actual duty: 60%. */.period_counts = (uint32_t) 0xa000,
  .duty_cycle_counts = 0x6000, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_comp_pwm_master_extend,
  .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_comp_pwm_master =
{ .p_ctrl = &g_timer_comp_pwm_master_ctrl, .p_cfg = &g_timer_comp_pwm_master_cfg, .p_api = &g_timer_on_gpt };
gpt_three_phase_instance_ctrl_t g_three_phase_comp_pwm_ctrl;
const three_phase_cfg_t g_three_phase_comp_pwm_cfg =
{ .buffer_mode = (THREE_PHASE_BUFFER_MODE_SINGLE), .p_timer_instance =
{ &g_timer_comp_pwm_master, &g_timer_comp_pwm_slave1, &g_timer_comp_pwm_slave2 },
  .callback_ch = THREE_PHASE_CHANNEL_U, .channel_mask = (1 << 0) | (1 << 1) | (1 << 2), .p_context = NULL, .p_extend =
          NULL, };
/* Instance structure to use this module. */
const three_phase_instance_t g_three_phase_comp_pwm =
{ .p_ctrl = &g_three_phase_comp_pwm_ctrl, .p_cfg = &g_three_phase_comp_pwm_cfg, .p_api =
