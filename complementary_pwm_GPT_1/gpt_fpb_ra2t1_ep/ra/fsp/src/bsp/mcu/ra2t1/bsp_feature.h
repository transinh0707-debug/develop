...
#define BSP_FEATURE_ACMPHS_VREF                                   (ACMPHS_REFERENCE_NONE)   // The IVREF selection that corresponds to the internal voltage reference.
...
#define BSP_FEATURE_GPT_AD_DIRECT_START_CHANNEL_MASK              (0x0FUL)          // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_GPT_COMPARE_MATCH_6EVENTS_SUPPORTED           (1UL)             // Has 6 compare match events.
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                  (0x08UL)          // Mask of channels that support event count input (has GTUPSR register).
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED                     (1UL)             // At least one channel supports event counts.
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK                         (0x0FUL)          // Mask of GPT channels that are the GPTE implementation.
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                        (0x0FUL)          // Mask of channels that support dead time control.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xF04F00FFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x708200FFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD                    (LVD_THRESHOLD_MONITOR_2_LEVEL_4_31V) // Typical higher bound of the detection threshold for LVD2.
...
#define BSP_FEATURE_POEG_MSTP_MSTPD13                             (1UL)             // Indicates the MSTP uses bit 13 of MSTPCRD to control the POEG.
...
#define BSP_FEATURE_RTC_HAS_VBTICTLR                              (0UL)             // Feature not available on this device.
