...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] =
        ...
        //           | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_04_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_GPT5) }, // GTCPPO0 pin

          { .pin = BSP_IO_PORT_04_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_IRQ_ENABLE
                  | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_04_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_05_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_09_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_09_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
                  | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },

          { .pin = BSP_IO_PORT_09_PIN_15, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) }, };
