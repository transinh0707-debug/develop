...
#define BSP_PERIPHERAL_ACMPHS_B_PRESENT          (1)
#define BSP_PERIPHERAL_ACMPHS_B_CHANNEL_MASK     (0x3U)
...
#define BSP_PERIPHERAL_AGTW_PRESENT              (1)
#define BSP_PERIPHERAL_AGTW_CHANNEL_MASK         (0x3U)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0xFU)
