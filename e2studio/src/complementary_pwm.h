...
#define COMP_PWM_MODE1_TIMER            (4U)    /* Menu option 4: Complementary PWM Mode 1 */
#define COMP_PWM_MODE2_TIMER            (5U)    /* Menu option 5: Complementary PWM Mode 2 */
#define COMP_PWM_MODE3_TIMER            (6U)    /* Menu option 6: Complementary PWM Mode 3 */
#define COMP_PWM_MODE4_TIMER            (7U)    /* Menu option 7: Complementary PWM Mode 4 */
...
typedef struct st_comp_pwm_cfg
{
    ...
    uint16_t dead_time;             /* Dead time value in timer counts (GTDVU) */
